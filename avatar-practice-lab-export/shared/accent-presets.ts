export interface AccentPreset {
  ...
  label: string;
  description: string;
  heygenLanguageCode: string;
}

export const ENGLISH_ACCENTS: AccentPreset[] = [
  {
    id: "american",
...
export function getAccentFromEthnicity(ethnicity: string | null | undefined): string {
  if (!ethnicity) return "american";
...
export function getAccentInstruction(accentId: string): string {
  switch (accentId) {
    case "indian":
