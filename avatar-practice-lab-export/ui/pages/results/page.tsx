        ...
        <div className="min-h-screen bg-[#fbfbfc]">
          <div className="bg-gradient-to-br from-[#000000] via-[#000000] to-[#000000] text-white py-16">
            <div className="max-w-4xl mx-auto px-4 text-center">
              ...
              <Link to="/interview">
                <Button className="bg-[#ee7e65] hover:bg-[#e06d54] text-white px-8 py-3 rounded-xl shadow-lg shadow-[#ee7e65]/25">
        ...
        <div className="bg-gradient-to-br from-[#000000] via-[#000000] to-[#000000] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <Link to="/interview">
                <Button className="gap-2 bg-[#ee7e65] hover:bg-[#e06d54] text-white font-semibold rounded-xl px-6 py-3 shadow-lg shadow-[#ee7e65]/25">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex gap-3 flex-1">
                <div className="relative flex-1">
                  <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-[#ee7e65]" />
                  <Input
                ...
                <select
                  ...
                  className="px-4 py-2.5 border border-slate-200 rounded-xl text-sm bg-white text-[#000000] font-medium min-w-[120px] focus:border-[#ee7e65] focus:ring-[#ee7e65]/20"
                >
              ...
              if (interviewsWithAnalysis.length === 0) {
                return (
                  <div className="bg-white rounded-xl border border-slate-200 p-8 text-center">
                    ...
                    <Link to="/interview">
                      <Button className="bg-[#ee7e65] hover:bg-[#e06d54]">Start Interview Practice</Button>
                    </Link>
                  </div>
                );
              }
          ...
          <div className="bg-gradient-to-r from-[#000000] to-[#000000] rounded-2xl p-5 sm:p-6 text-white shadow-xl">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <Link to={`/jobs/${(activeJobs[0] as { id: string }).id}`} className="sm:flex-shrink-0">
                <Button className="bg-[#ee7e65] hover:bg-[#e06d54] text-white gap-2 w-full sm:w-auto font-semibold rounded-xl shadow-lg shadow-[#ee7e65]/25">
                  <Play className="w-4 h-4" />
                  Practice Now
                </Button>
              </Link>
