      ...
      <ul>
        <li>
          <div className="flex flex-row gap-2">
            <p className="text-blue-600 font-semibold">Start:</p> Start the
            Interactive Avatar session
          </div>
        </li>
        <li>
          <div className="flex flex-row gap-2">
            <p className="text-blue-600 font-semibold">Close:</p> Close the
            Interactive Avatar session
          </div>
        </li>
        <li>
          <div className="flex flex-row gap-2">
            <p className="text-blue-600 font-semibold">Speak:</p> Repeat the
            input
          </div>
        </li>
      </ul>
